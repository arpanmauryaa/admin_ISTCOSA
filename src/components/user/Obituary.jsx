...
function Obituary({ redioValue }) {
    const [obituary, setObituary] = useState()

    const obituaryFunction = () => {
                                        ...
                                        <tr className=" bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            <td scope="row" className="px-2 py-4  text-gray-900  dark:text-white">
                                                <div className='flex'>
                                                    ...
                                                    {/* <RxCross1 className='text-xl text-red-600 ms-1 cursor-pointer' /> */}
                                                    <UserModal iconValue={item.IsAlive} getFunction={obituaryFunction} id={item.RollNumberID} />
                                                    {
                                                    ...
                                                    {/* <FaUser className='text-md mt-1 ms-1  cursor-pointer' /> */}
                                                    <FaToolbox className='text-lg text-gray-600 ms-1 cursor-pointer' />
                                                    <AiOutlineStop className='text-xl  ms-1 cursor-pointer' />
                                                </div>
                                            </td>
